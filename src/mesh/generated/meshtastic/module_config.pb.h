...
/* APRS Module Config */
typedef struct _meshtastic_ModuleConfig_APRSConfig {
    /* Whether the APRS Module is enabled */
    bool enabled;
    /* APRS frequency in MHz (default: 144.800 MHz) */
    float frequency;
    /* LoRa spreading factor (7-12) */
    uint32_t spreading_factor;
    /* LoRa bandwidth in kHz (125, 250, 500) */
    uint32_t bandwidth;
    /* LoRa coding rate denominator (5-8, where actual rate is 4/denominator) */
    uint32_t coding_rate;
    /* Transmission power in dBm */
    uint32_t tx_power;
    /* APRS callsign (max 6 characters) */
    pb_callback_t callsign;
    /* APRS SSID (0-15) */
    uint32_t ssid;
    /* Beacon interval in seconds */
    uint32_t beacon_interval;
    /* Use position data for APRS beacon */
    bool use_position_data;
    /* Use custom message in APRS packet */
    bool use_custom_message;
    /* Custom message to include in APRS packet */
    pb_callback_t custom_message;
} meshtastic_ModuleConfig_APRSConfig;
...
typedef struct _meshtastic_ModuleConfig {
    ...
    union {
        ...
        /* APRS Module Config */
        meshtastic_ModuleConfig_APRSConfig aprs;
    } payload_variant;
...
#define meshtastic_ModuleConfig_APRSConfig_init_default {0, 0, 0, 0, 0, 0, {{NULL}, NULL}, 0, 0, 0, 0, {{NULL}, NULL}}
...
#define meshtastic_ModuleConfig_APRSConfig_init_zero {0, 0, 0, 0, 0, 0, {{NULL}, NULL}, 0, 0, 0, 0, {{NULL}, NULL}}
...
#define meshtastic_ModuleConfig_APRSConfig_enabled_tag 1
#define meshtastic_ModuleConfig_APRSConfig_frequency_tag 2
#define meshtastic_ModuleConfig_APRSConfig_spreading_factor_tag 3
#define meshtastic_ModuleConfig_APRSConfig_bandwidth_tag 4
#define meshtastic_ModuleConfig_APRSConfig_coding_rate_tag 5
#define meshtastic_ModuleConfig_APRSConfig_tx_power_tag 6
#define meshtastic_ModuleConfig_APRSConfig_callsign_tag 7
#define meshtastic_ModuleConfig_APRSConfig_ssid_tag 8
#define meshtastic_ModuleConfig_APRSConfig_beacon_interval_tag 9
#define meshtastic_ModuleConfig_APRSConfig_use_position_data_tag 10
#define meshtastic_ModuleConfig_APRSConfig_use_custom_message_tag 11
#define meshtastic_ModuleConfig_APRSConfig_custom_message_tag 12
...
#define meshtastic_ModuleConfig_aprs_tag         14
...
X(a, STATIC,   ONEOF,    MESSAGE,  (payload_variant,aprs,payload_variant.aprs),  14)
...
#define meshtastic_ModuleConfig_payload_variant_aprs_MSGTYPE meshtastic_ModuleConfig_APRSConfig
...
#define meshtastic_ModuleConfig_APRSConfig_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, BOOL,     enabled,           1) \
X(a, STATIC,   SINGULAR, FLOAT,    frequency,         2) \
X(a, STATIC,   SINGULAR, UINT32,   spreading_factor,   3) \
X(a, STATIC,   SINGULAR, UINT32,   bandwidth,         4) \
X(a, STATIC,   SINGULAR, UINT32,   coding_rate,       5) \
X(a, STATIC,   SINGULAR, UINT32,   tx_power,          6) \
X(a, CALLBACK, SINGULAR, STRING,   callsign,          7) \
X(a, STATIC,   SINGULAR, UINT32,   ssid,              8) \
X(a, STATIC,   SINGULAR, UINT32,   beacon_interval,   9) \
X(a, STATIC,   SINGULAR, BOOL,     use_position_data,  10) \
X(a, STATIC,   SINGULAR, BOOL,     use_custom_message,  11) \
X(a, CALLBACK, SINGULAR, STRING,   custom_message,   12)
#define meshtastic_ModuleConfig_APRSConfig_CALLBACK pb_default_field_callback
#define meshtastic_ModuleConfig_APRSConfig_DEFAULT NULL
...
extern const pb_msgdesc_t meshtastic_ModuleConfig_APRSConfig_msg;
...
#define meshtastic_ModuleConfig_APRSConfig_fields &meshtastic_ModuleConfig_APRSConfig_msg
...
/* meshtastic_ModuleConfig_APRSConfig_size depends on runtime parameters */
