...
typedef enum _meshtastic_HardwareModel {
 ...
 https://heltec.org/project/meshsolar/ */
    ...
    /* GAT562 Mesh Trial Tracker based on nRF52840 */
    meshtastic_HardwareModel_GAT562_MESH_TRIAL_TRACKER = 115,
    /* ------------------------------------------------------------------------------------------------------------------------------------------
...
union meshtastic_FromRadio_payload_variant_size_union {char f9[(6 + meshtastic_ModuleConfig_size)]; char f0[504];};
#endif
